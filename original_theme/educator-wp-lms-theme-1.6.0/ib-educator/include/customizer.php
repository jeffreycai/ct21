...
class Educator_Theme_Customize {
	...
	public static function login_register_settings( $wp_customize ) {
		...
		$wp_customize->add_control(
			...
			array(
				'label'    => __( 'Enable custom user flow', 'ib-educator' ) . ' (beta)',
				'section'  => 'educator_login_settings',
		...
		$wp_customize->add_control(
			...
			array(
				'label'    => __( 'Enable captcha on registration form', 'ib-educator' ),
				'section'  => 'educator_login_settings',
		...
		$wp_customize->add_control(
			...
			array(
				'label'    => __( 'ReCaptcha Site Key', 'ib-educator' ),
				'section'  => 'educator_login_settings',
		...
		$wp_customize->add_control(
			...
			array(
				'label'    => __( 'ReCaptcha Secret Key', 'ib-educator' ),
				'section'  => 'educator_login_settings',
