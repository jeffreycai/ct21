...
function educator_enqueue_scripts() {
	...
	wp_enqueue_style( 'educator-style', get_template_directory_uri() . '/style.css', array(), '1.6.0' );
	...
	wp_enqueue_script( 'educator-base', get_template_directory_uri() . '/js/base.js', array( 'jquery' ), '1.6.0', true );
	wp_enqueue_script( 'educator-main', get_template_directory_uri() . '/js/main.js', array( 'jquery' ), '1.6.0', true );
