...
<?php
	...
	$ufw_enabled = get_option( 'ib_ufw_enabled' );
?>
						...
						<div class="register-form">
							<form id="registerform1" name="registerform" action="<?php echo esc_url( $form_action ); ?>" method="post">
								...
								<p class="login-username">
									...
									<input type="text" name="user_login" id="register-login" class="input" value="<?php echo esc_attr( $user_login ); ?>">
								</p>
								...
								<?php if ( $ufw_enabled ) : ?>
									...
									<p class="user-password">
										...
										<input type="password" name="user_pass" id="user-password" class="input" required>
									</p>
									...
									<p class="user-repeat-password">
										...
										<input type="password" name="repeat_user_pass" id="user-repeat-password" class="input" required>
									</p>
