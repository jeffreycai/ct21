...
<form class="form-horizontal" role="form" method="POST" action="<?php echo uri('admin/news/edit/' . $object->getId()) ?>">
...
?>
    ...
    <script type='text/javascript'>
      $('#oiPth .datepicker').datepicker({
        dateFormat: '@'
        ,altField: "#oiPth .altFormat", altFormat: "yy-mm-dd"
        ,changeMonth: 1
        ,changeYear: 1
        ,yearRange: 'c-5:c+10'
      });
      $('#oiPth .input-group-addon').css('cursor', 'pointer').on('click', function(){
        $('#oiPth .datepicker').datepicker('show');
      });
    </script>
