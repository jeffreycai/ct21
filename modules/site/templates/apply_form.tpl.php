...
<div class='form-group field-full-width'>
  <label class='col-sm-2 control-label'>Country to apply </label>
  <div class='col-sm-10'>
...
<div class='form-group field-full-width'>
  <label class='col-sm-2 control-label' for='apply_institution'>Institution to apply </label>
  <div class='col-sm-10'>
...
<div class='form-group field-full-width'>
  <label class='col-sm-2 control-label' for='apply_course'>Course to apply </label>
  <div class='col-sm-10'>
...
<!-- END OF js code for #passport_uploader -->
    ...
    <div class="form-group">
      <label for="graduation_certificate" class="col-sm-2 control-label">Graduation certificate</label>
      <div class="col-sm-10">
...
<!-- END OF js code for #graduation_certificate_uploader -->
    ...
    <div class="form-group">
      <label for="degree_certificate" class="col-sm-2 control-label">Degree certificate</label>
      <div class="col-sm-10">
...
<!-- END OF js code for #degree_certificate_uploader -->
    ...
    <div class="form-group">
      <label for="academic_transcripts" class="col-sm-2 control-label">Academic transcripts</label>
      <div class="col-sm-10">
...
<!-- END OF js code for #academic_transcripts_uploader -->
    ...
    <div class="form-group">
      <label for="ielts_transcripts" class="col-sm-2 control-label">IELTS transcripts</label>
      <div class="col-sm-10">
...
<!-- END OF js code for #ielts_transcripts_uploader -->
  ...
  <button type="submit" name="submit" class="btn btn-default button"><?php i18n_echo(array(
      'en' => 'Create', 
      'zh' => '创建'
  )) ?></button>
</form>
