 ...
 * - content
 */
class BaseBlock extends DBObject {
  /**
  ...
  static function tableExist() {
    return parent::tableExistByName('block');
  }
...
COLLATE = utf8_general_ci;
  ...
  static function findById($id, $instance = 'Block') {
    global $mysqli;
  ...
  static function findAllWithPage($page, $entries_per_page) {
    global $mysqli;
    $query = "SELECT * FROM block LIMIT " . ($page - 1) * $entries_per_page . ", " . $entries_per_page;
    $result = $mysqli->query($query);
