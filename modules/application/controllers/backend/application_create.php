...
if (isset($_POST['submit'])) {
  ...
  if ($error_flag == false) {
    if ($object->save()) {
      ...
      sendemailAdmin('Apply for course', '<p>A new application for course has just been submitted: <br /><a href="http://en.websitesydney.net/admin/application/edit/'.$object->getId().'">http://en.ct21.com.au/admin/application/edit/'.$object->getId().'</a></p>');
...
$html->renderOut('application/backend/application_create', array(
  'object' => $object
));
