...
$perpage = 50;
$total = Application::countAll();
$total_page = ceil($total / $perpage);
$html->renderOut('application/backend/application_list', array(
    'objects' => Application::findAllWithPage($page, $perpage),
    'current_page' => $page,
