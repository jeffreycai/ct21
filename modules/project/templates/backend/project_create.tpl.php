...
<div class='hr-line-dashed'></div>
    ...
    <script type='text/javascript'>
      $('#Ft87b .datepicker').datepicker({
        dateFormat: '@'
        ,altField: "#Ft87b .altFormat", altFormat: "yy-mm-dd"
        ,changeMonth: 1
        ,changeYear: 1
        ,yearRange: 'c-5:c+10'
      });
      $('#Ft87b .input-group-addon').css('cursor', 'pointer').on('click', function(){
        $('#Ft87b .datepicker').datepicker('show');
      });
    </script>
